...
tasks_languages=Více jazykù
tasks_allusers=všechny uivatele
tasks_selectusers=Instalovat %1 pro:
tasks_currentuser=jen %1
tasks_multisetup=Povolit pøístup více uivatelù
tasks_firewall=Pøidat pravidlo do Windows firewallu
tasks_upnp=Povolit zjišování UPnP zaøízení
tasks_deleteoldsetup=Smazat staré instalátory
tasks_resetdiscoveryhostcache=Obnovit seznamy serverù
run_skinexe=Spouštím instalaci skinù...
reg_incomingchat=Pøíchozí zpráva chatu
reg_apptitle=Shareaza Ultimate File Sharing
icons_license=Licence
icons_uninstall=Odinstalovat
icons_downloads=Staené soubory
icons_basicmode=Normální reim
icons_tabbedmode=Reim záloek
icons_windowedmode=Reim oken
dialog_shutdown=Aplikace %1 je spuštìna. Chcete ukonèit %1 a pokraèovat v instalaci?
dialog_firewall=Instalátor nemùe pøidat pravidlo pro Shareazu do nastavení Windows Firewallu.%nProsím pøidejte pravidlo ruènì.
dialog_malwaredetected=Byl nalezen škodlivı software (malware) v %1. Pøed pokraèování instalace jej prosím odstraòte pomocí vhodného nástroje pro odstraòování škodlivého softwaru. Ukonèit instalaci?
page_viruswarning_text=Pøi pouívání internetu se vdy ujistìte, e máte aktuální antivirovı program, kterı vás chrání pøed nebezpeènımi a škodlivımi programy. Seznam vhodnıch programù a další rady tıkající se bezpeènosti mùete nalézt na následující adrese:
page_viruswarning_title=Nalezen virus
page_viruswarning_subtitle=Máte nainstalovanı antivirovı program?

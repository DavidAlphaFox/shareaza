...
components_plugins=Pluginek
components_skins=Kinézetek
tasks_languages=Nyelvek telepítése
tasks_allusers=Minden felhasználó
tasks_selectusers=Megadott felhaszáló:
tasks_currentuser=Jelenlegi felhasználó
tasks_multisetup=Többfelhasználós mód engedélyezése
tasks_firewall=Felvétel a Windows tûzfal kivételeihez
tasks_upnp=Automatikus routerbeállítás (UPnP szolgáltatás)
tasks_deleteoldsetup=Régi telepítõk törlése
tasks_resetdiscoveryhostcache=A Szerverkeresõ és a Kiszolgálók listájának alaphelyzetbe állítása
run_skinexe=Kinézet telepítése folyamatban...
reg_incomingchat=Bejövõ chat üzenet
reg_apptitle=Shareaza fájlmegosztó program
icons_license=Licenc
icons_uninstall=Shareaza eltávolítása
icons_downloads=Letöltések
icons_basicmode=Egyszerû nézet
icons_tabbedmode=Összetett nézet
icons_windowedmode=Ablakos nézet
dialog_shutdown=A %1 jelenleg fut. Be akarja zárni a programot, hogy a telepítés folytatódhasson?
dialog_firewall=A telepítõ nem tudta hozzáadni a Shareazát a Windows tûzfal kivételeihez.%nManuálisan kell ezt megtenni.
dialog_malwaredetected=A telepítõ egy kártékony programot talált a rendszerben: %1. Mielõtt telepítené a Shareazát, elõbb távolítsa el azt. Ki akar most lépni?
page_viruswarning_text=Az internet használata során mindig legyen feltelepítve egy, a legfrissebb vírusadatbázissal rendelkezõ antivírus program, ami megvéd a férgektõl, trójai és egyéb kártékony programoktól. Ha követi ezt a linket, sok jó víruskeresõt találhat és további hasznos tippeket kaphat a számítógép védelmérõl:
page_viruswarning_title=Vírusveszély
page_viruswarning_subtitle=Van feltelepített antivírus programja?
PathNotExist=Hiba, a megadott %1 mappa nem létezik

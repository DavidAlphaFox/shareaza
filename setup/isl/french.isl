...
tasks_languages=Langues
tasks_allusers=Tous les utilisateurs
tasks_selectusers=Installer %1 pour :
tasks_currentuser=%1 seulement
tasks_multisetup=Activer le support multi-utilisateurs
tasks_firewall=Ajouter une exception au Pare-feu Windows
tasks_upnp=Activer UPnP pour essayer de découvrir les pare-feux/routeurs.
tasks_deleteoldsetup=Voulez-vous supprimer les anciens fichiers d'installation de Shareaza ?
tasks_resetdiscoveryhostcache=Remettre à zéro les services de découverte et le tampon pour les hôtes
run_skinexe=Installation de la skin en cours...
reg_incomingchat=Réception d'un message chat
reg_apptitle=Shareaza Ultimate File Sharing
icons_license=Licence
icons_uninstall=Désinstaller
icons_downloads=Téléchargements
icons_basicmode=Mode simple
icons_tabbedmode=Mode tabulé
icons_windowedmode=Mode fenêtré
dialog_shutdown=%1 est en cours d'exécution. Voulez-vous quitter %1 pour que l'installation puisse se poursuivre ?
dialog_firewall=L'installation n'a pas pu ajouter Shareaza au Pare-feu Windows.%nVeuillez ajouter Shareaza manuellement à la liste des exceptions.
dialog_malwaredetected=Un logiciel malveillant a été détecté sur votre système à %1, veuillez l'enlever avec un antivirus avant d'installer Shareaza. Voulez-vous quitter maintenant ?
page_viruswarning_text=Lorsque vous utilisez internet, vous devriez toujours vous assurer que vous avez un antivirus à jour pour vous protéger des troyens (trojans), vers (worms), et autres programmes malveillants. Vous pouvez trouver une liste de bons antivirus et des conseils de sécurité pour protéger votre ordinateur en suivant ce lien :
page_viruswarning_title=Avertissement sur les virus
page_viruswarning_subtitle=Avez-vous un antivirus installé ?

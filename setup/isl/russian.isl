...
components_plugins=Модули
components_skins=Шкурки
tasks_languages=Языки
tasks_allusers=Всем пользователям
tasks_selectusers=Установить %1 для:
tasks_currentuser=Только для %1
tasks_multisetup=Разрешить поддержку нескольких пользователей
tasks_firewall=Добавить в список исключений бранмауэра Windows
tasks_upnp=Включить нахождение устройсв UPnP
tasks_deleteoldsetup=Удалить старые инсталляторы
tasks_resetdiscoveryhostcache=Сбросить ресурсы соединений и кэш хостов
run_skinexe=Идёт установка шкурок...
reg_incomingchat=Входящее сообщение для чата
reg_apptitle=Shareaza - программа для обмена файлами
icons_license=Лицензия
icons_uninstall=Деинсталляция
icons_downloads=Загрузки
icons_basicmode=Обычный режим
icons_tabbedmode=Режим закладок
icons_windowedmode=Оконный режим
dialog_shutdown=%1 в данный момент работает. Хотите ли завершить работу %1, чтобы продолжить установку?
dialog_firewall=Программа установки не смогла добавить Shareaza в список исключений брандмауэра Windows.%nПожалуйста, добавьте ее в этот список вручную.
dialog_malwaredetected=В Вашей системе обнаруженны вредоносные программы (%1), удалите их перед инсталляцией Shareaza при промощи антивирусной программы или сканера. Хотите выйти сейчас?
page_viruswarning_text=Всегда, когда пользуетесь интернетом, удостоверьтесь, что у Вас есть новейший сканер для вирусов, чтобы защитить компьютер от троянов, червей и других вредительских программ. Вы можете найти список хороших сканеров для вирусов и другие советы о защите компьютера по этому адресу:
page_viruswarning_title=Предостережение о вирусах
page_viruswarning_subtitle=Имеете ли Вы установленную антивирусную программу?
PathNotExist=Ошибка, путь к папке %1 не существует

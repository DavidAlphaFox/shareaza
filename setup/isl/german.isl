...
tasks_languages=Sprachen
tasks_allusers=Alle Benutzer
tasks_selectusers=Installieren %1 für:
tasks_currentuser=Nur für %1
tasks_multisetup=Mehrbenutzerunterstützung aktivieren
tasks_firewall=Eine Ausnahme zur Windows-Firewall hinzufügen
tasks_upnp=Automatische Routerkonfiguration benutzen ( UPnP )
tasks_deleteoldsetup=Alte Installer löschen
tasks_resetdiscoveryhostcache=Service-Provider und Host-Cache zurücksetzen
run_skinexe=Skin-Installer einrichten...
reg_incomingchat=Eingehende Chatnachricht
reg_apptitle=Shareaza
icons_license=Lizenz
icons_uninstall=Shareaza deinstallieren
icons_downloads=Downloads
icons_basicmode=Normalmodus
icons_tabbedmode=Tab-Modus
icons_windowedmode=Fenstermodus
dialog_shutdown=%1 wird zur Zeit ausgeführt. Wollen Sie %1 beenden, um mit der Installation fortzufahren?
dialog_firewall=Setup konnte Shareaza nicht zur Windows-Firewall hinzufügen.%nBitte tragen Sie Shareaza manuell in die Ausnahmenliste ein.
dialog_malwaredetected=Auf ihrem Computer wurde schädliche Software im Ordner %1 entdeckt. Bitte entfernen Sie die Software mit Hilfe eines Viren- bzw. Malware-Scanners bevor Sie mir der Installation von Shareaza fortfahren.Möchten sie die Installation jetzt abbrechen?
page_viruswarning_text=Wenn Sie das Internet benutzen, sollten Sie stets einen aktuellen Virenscanner installiert haben, der ihren Computer vor Trojanern, Würmern und anderen bösartigen Programmen beschützt. Sie finden eine Liste guter Virenscanner und andere Tipps, wie Sie ihren Computer schützen können, unter folgendem Link:
page_viruswarning_title=Virenwarnung
page_viruswarning_subtitle=Haben Sie ein Antivirenprogramm installiert?
PathNotExist=Fehler: der Pfad zum %1-Ordner existiert nicht

...
tasks_languages=Γλώσσες
tasks_allusers=Όλοι οι χρήστες
tasks_selectusers=Εγκατάσταση %1 για:
tasks_currentuser=%1 μόνο
tasks_multisetup=Ενεργοποίηση της βοήθειας πολλαπλών χρηστών
tasks_firewall=Βάλε μια εξαίρεση στο τείχος προστασίας των Windows
tasks_upnp=Enable discovery of UPnP devices
tasks_deleteoldsetup=Διέγραψε την παλιά εγκατάσταση
tasks_resetdiscoveryhostcache=Reset Discovery and Hostcache
run_skinexe=Running Εγκατάσταση του skin...
reg_incomingchat=Νέο μήνυμα chat
reg_apptitle=Shareaza Ultimate File Sharing
icons_license=’δεια
icons_uninstall=Απεγκατάσταση
icons_downloads=Κατέβασμα
icons_basicmode=Κανονική Μορφή
icons_tabbedmode=Παραθυρική Μορφή
icons_windowedmode=Μορφή Windowed
dialog_shutdown=Το %1 ακόμα τρέχει. Θέλετε να τερματίσετε την λειτουργεία του %1 για να συνεχιστεί η εγκατάσταση?
dialog_firewall=Η εγκατάσταση του προγράμματος απέτυχε να προσθέσει το Shareaza στο Windows Firewall. % Παρακαλώ προσθέστε το Shareaza στην exception λίστα χειροκίνητα
...
page_viruswarning_text=Όταν χρησιμοποιείτε το internet, θα πρέπει πάντα να έχετε ένα πρόγραμμα προστασίας για ιούς ενημερωμένο για να σας προστατεύει απο αυτούς και άλλα επικίνδυνα προγράμματα. Μπορείτε να βρείτε μια λίστα με καλά προγράμματα προστασίας για ιούς και άλλα βοηθήματα για να προστατέψετε τον υπολογιστή σας ακολουθώντας αυτόν τον σύνδεσμο:
page_viruswarning_title=Προειδοποίηση για ιό
page_viruswarning_subtitle=Έχετε ένα πρόγραμμα προστασίας για ιούς εγκατεστημένο?

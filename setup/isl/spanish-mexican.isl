...
tasks_languages=Idiomas
tasks_allusers=Todos los usuarios
tasks_selectusers=Instalar %1 para:
tasks_currentuser=%1 solamente
tasks_multisetup=Habilitar soporte multi-usuario
tasks_firewall=Agregar una excepción al Firewall de Windows
tasks_upnp=Enable discovery of UPnP devices
tasks_deleteoldsetup=Borrar archivos de instaladores viejos
tasks_resetdiscoveryhostcache=Reset Discovery and Hostcache
run_skinexe=Instalando Skin...
reg_incomingchat=Hay un mensaje de chat entrante
reg_apptitle=Shareaza Ultimate File Sharing
icons_license=Licencia
icons_uninstall=Desinstalar
icons_downloads=Descargas
icons_basicmode=Modo Básico
icons_tabbedmode=Modo Avanzado
icons_windowedmode=Modo Ventanas
dialog_shutdown=%1 se encuentra ejecutándose. ¿Deseas que %1 sea cerrado para que la instalación pueda continuar?
dialog_firewall=La instalación fallo al agregar la excepción de Shareaza al cortafuego Firewall.%n Por favor hágalo manualmente.

...
components_plugins=Wtyczki
components_skins=Skórki
tasks_languages=Jêzyki
tasks_allusers=Dla wszystkich u¿ytkowników
tasks_selectusers=Instaluj dla %1:
tasks_currentuser=tylko %1
tasks_multisetup=W³¹cz obs³ugê wielu u¿ytkowników
tasks_firewall=Dodaj wyj¹tek do Firewall'a Windows'a
tasks_upnp=Enable discovery of UPnP devices
tasks_deleteoldsetup=Usuñ stare instalatory
tasks_resetdiscoveryhostcache=Reset Discovery and Hostcache
run_skinexe=Instalowanie skórek...
reg_incomingchat=Przychodz¹ca wiadomoœæ chatowa
reg_apptitle=Shareaza Ultimate File Sharing
icons_license=Licencja
icons_uninstall=Odinstaluj
icons_downloads=Pobierania
icons_basicmode=Tryb normalny
icons_tabbedmode=Tryb zaawansowany
icons_windowedmode=Tryb okienkowy
dialog_shutdown=%1 obecnie dzia³a. Czy chcia³byœ wy³¹czyæ %1 aby kontynuowaæ instalacjê?
dialog_firewall=Instalator nie potrafi³ dodaæ Shareazy do Firewall'a Windows'a.%nProszê dodaæ Shareazê do listy wyj¹tków rêcznie.

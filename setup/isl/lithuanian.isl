...
components_plugins=Papildiniai
components_skins=Apvalkalai
tasks_languages=Kalbos
tasks_allusers=Visiems vartotojams
tasks_selectusers=Ádiegti „%1“ ðiems vartotojams:
tasks_currentuser=Tik vartotojui %1
tasks_multisetup=Ágalinti keliø vartotojø palaikymà
tasks_firewall=Pridëti prie Windows ugniasienës iðimèiø sàraðo
tasks_upnp=Ágalinti UPnP árenginiø aptikimà
tasks_deleteoldsetup=Trinti senas diegimo programas
tasks_resetdiscoveryhostcache=Apnulinti tarnybas ir adresatø talpyklas
run_skinexe=Vykdoma apvalkalo sàranka...
reg_incomingchat=Gaunama þinutë pokalbiui
reg_apptitle=Shareaza — geriausia programa bylø mainams
icons_license=Licencinë sutartis
icons_uninstall=Paðalinti
icons_downloads=Atsisiuntimai
icons_basicmode=Áprastinë veiksena
icons_tabbedmode=Korteliø veiksena
icons_windowedmode=Langø veiksena
dialog_shutdown=„%1“ ðiuo metu dirba. Ar norite nutraukti „%1“ darbà, tam kad bûtø galima tæsti ádiegimà?
dialog_firewall=Ádiegimo programai nepavyko pridëti „Shareaza“ prie Windows ugniasienës iðimèiø sàraðo.%nPridëkite jà á ðá sàraðà rankiniu bûdu.
dialog_malwaredetected=Jûsø sistemoje aptiktos kenkëjiðkos programos (%1). Prieð diegdami „Shareaza“, paðalinkite jas antivirusine programa ar skeneriu. Nutraukti diegimà dabar?
page_viruswarning_text=Visada, kai naudojatës Internetu, ásitikinkite, jog turite naujausià virusø skenerá, tam kad bûtumëte apsaugoti nuo trojanø, kirminø ir kitokiø kenkëjiðkø programø. Jûs galite rasti gerø virusø skeneriø sàraðà ir kitokius kompiuterio apsaugojimo patarimus nuëjæ ðiuo adresu:
page_viruswarning_title=Áspëjimas apie virusus
page_viruswarning_subtitle=Ar Jûs turite ásidiegæ antivirusinæ programà?
PathNotExist=Klaida, katalogo kelias „%1“ neegzistuoja
